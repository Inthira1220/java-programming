package OfficeHours_Saim_Practice_05_10_2021;
...
//        digits and letters from a string and stores them into separate ArrayLists of
//        Characters
//        Ex: str = "ABCD123$%#@&456EFG!"
//        list1: {$, %, #, @, &, !}
//        list2: {A, B, C, D, E, F, G}
//        list3: {1, 2, 3, 4, 5, 6}
//        Challenge: make a method that will do this action and
//        it will return an ArrayList which holds all 3 of the other ArrayLists
