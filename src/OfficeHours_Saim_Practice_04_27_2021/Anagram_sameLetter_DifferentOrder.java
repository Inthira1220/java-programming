package OfficeHours_Saim_Practice_04_27_2021;

import java.util.*;

public class Anagram_sameLetter_DifferentOrder {
    public static void main(String[] args) {
        /**
         * Create a method that will accept two Strings. Check if the two Strings are anagram of each other.
         * If they are anagram return true otherwise return false.
         *
