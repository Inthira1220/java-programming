...
public class replitval6 {
    public static void main(String[] args) {
        ...
        String p3 = "Bob";
        String p2 = "Jill";
        System.out.println(p1+(", ")+p4+(", ")+p5+(", ")+p3+(", ")+p2);
    }
}

/*
||James, Betty, Herb, Bob, Jill
Five friends are going to the theater. They have purchased a
row of five seats with an aisle on either end.
...
Specify the seating order as the names separated by commas and
a space (as in the above example). Use variables and print names in the right order.
 */